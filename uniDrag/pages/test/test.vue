			...
			getAlbum(){
				...
				// if(this.cardId){
					...
					// getAlbum(this.cardId).then(res => {
						this.album.list = [{URL: "https://ss1.bdstatic.com/70cFuXSh_Q1YnxGkpoWK1HF6hhy/it/u=2110374320,3065268547&fm=27&gp=0.jpg"},
							{URL: "https://ss2.bdstatic.com/70cFvnSh_Q1YnxGkpoWK1HF6hhy/it/u=2574726603,3187764477&fm=27&gp=0.jpg"}];
